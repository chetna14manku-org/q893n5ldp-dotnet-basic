...
export IMAGE_URL=${IMAGE_URL-quay.io/chetna14manku_org/rhtap-qe-dotnet-basic:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/chetna14manku-org/q893n5ldp-dotnet-basic-gitops
